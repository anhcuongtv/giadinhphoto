...
<table cellspacing="8" style="font-family:Arial, Helvetica, sans-serif">
  ...
  <tr>
  	<td width="150" style="font-weight:bold;">{$lang.controller.orderStatus}:</td>
  ...
  <tr>
    ...
    <td>
    	...
    	<div>({$lang.controller.billingPhone} : {$setting.seller.phone})</div>
    </td>
  </tr>
  <tr>
...
<table cellspacing="8" width="100%" style="border-bottom:2px solid #444444;font-family:Arial, Helvetica, sans-serif;">
	<tr>
  	<td align="left" valign="bottom">
    	<div style="font-weight:bold;font-size:28px;">{$lang.controller.billingShipInfo}</div>
      </td>
...
<table cellspacing="8" width="100%" style="border-bottom:2px solid #444444;font-family:Arial, Helvetica, sans-serif;">
	<tr>
 		<td width="150" style="font-weight:bold;" valign="top">{$lang.controller.BillingInfo}: </td>
    <td valign="top" align="left">
    	<div style="font-weight:bold;">{$myOrder->shippingFirstname} {$myOrder->shippingMid} {$myOrder->shippingLastname}</div>
      <div>{$myOrder->shippingAddress} {if $myOrder->shippingAddress2 != ''}({$lang.controller.printOtherAddress}: {$myOrder->shippingAddress2}){/if}</div>
      ...
      <div>({$lang.controller.billingPhone} : {$myOrder->shippingPhone} {if $myOrder->shippingPhone2 != ''} - {$lang.controller.billingPhone2} : {$myOrder->shippingPhone2}{/if})</div>     
    </td>
	</tr>
...
<table width="100%" style="font-family:Arial, Helvetica, sans-serif;">
	<tr>
  	...
  	<td align="left" style="font-weight:bold;">{$lang.controller.itemproduct}</td>
    <td width="70" align="right" style="font-weight:bold;">{$lang.controller.itemprice}</td>
    <td width="50" align="center" style="font-weight:bold;">{$lang.controller.itemquantity}</td>
    <td width="150" align="right" style="font-weight:bold;">{$lang.controller.itemsubtotal}</td>
  </tr>
  {foreach name="productlist" item=item from=$productList}
      <tr>
...
<tr>
   <td align="right">
   	<br/><br/>
      	...
      	<tr>
        	<td align="right">{$lang.controller.cartSubTotal}:</td><td align="right" width="100">{$currency->formatPrice($totalprice)}</td>
        </tr>
