<?php /* Smarty version 2.6.26, created on 2012-07-31 08:56:56
         compiled from _controller/admin/page/index.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'count', '_controller/admin/page/index.tpl', 20, false),array('function', 'paginate', '_controller/admin/page/index.tpl', 44, false),)), $this); ?>
...
page/add"><?php echo $this->_tpl_vars['lang']['controller']['head_add']; ?>
</a></li>
		</ul>
		<div class="clear"></div>  
...
unset($_smarty_tpl_vars);
 ?>
			<form action="" method="post" name="manage" onsubmit="return confirm('Are You Sure ?');">
				<input type="hidden" name="ftoken" value="<?php echo $_SESSION['pageDeleteToken']; ?>
" />
				<table class="grid">
					...
					<thead>
						<tr>
						   <th width="40" align="left"><input class="check-all" type="checkbox" /></th>
							...
							<th align="left"><?php echo $this->_tpl_vars['lang']['controller']['formIdtextLabel']; ?>
</th>							
...
" />
    ...
    foreach ($_from as $this->_tpl_vars['webpage']):
?>
					
						<tr>
							<td><input type="checkbox" name="fbulkid[]" value="<?php echo $this->_tpl_vars['webpage']->id; ?>
" <?php if (in_array ( $this->_tpl_vars['webpage']->id , $this->_tpl_vars['formData']['fbulkid'] )): ?>checked="checked"<?php endif; ?>/></td>
							<td style="font-weight:bold;"><?php echo $this->_tpl_vars['webpage']->id; ?>
</td>
							<td><a href="<?php echo $this->_tpl_vars['conf']['rooturl_admin']; ?>
page/edit/id/<?php echo $this->_tpl_vars['webpage']->id; ?>
/redirect/<?php echo $this->_tpl_vars['redirectUrl']; ?>
"><?php echo $this->_tpl_vars['webpage']->idtext; ?>
</a></td>
							<td class="td_center"><?php if ($this->_tpl_vars['webpage']->enable == 1): ?><img border="0" src="<?php echo $this->_tpl_vars['currentTemplate']; ?>
...
page/delete/id/<?php echo $this->_tpl_vars['webpage']->id; ?>
/redirect/<?php echo $this->_tpl_vars['redirectUrl']; ?>
