<?php /* Smarty version 2.6.26, created on 2016-09-16 15:18:08
         compiled from _controller/admin/contestphotoready/index.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'count', '_controller/admin/contestphotoready/index.tpl', 29, false),array('modifier', 'upper', '_controller/admin/contestphotoready/index.tpl', 33, false),array('modifier', 'date_format', '_controller/admin/contestphotoready/index.tpl', 86, false),array('modifier', 'htmlspecialchars', '_controller/admin/contestphotoready/index.tpl', 110, false),array('function', 'paginate', '_controller/admin/contestphotoready/index.tpl', 61, false),)), $this); ?>
...
contestphotoready"><?php echo $this->_tpl_vars['lang']['controllergroup']['formViewAll']; ?>
</a></li>
		</ul>
		<?php endif; ?>
		<ul class="content-box-link">
			<li><a href="<?php echo $this->_tpl_vars['conf']['rooturl_admin']; ?>
contestphotoready/generate"><?php echo $this->_tpl_vars['lang']['controller']['head_generate']; ?>
</a></li>
            <li><a href="<?php echo $this->_tpl_vars['conf']['rooturl_admin']; ?>
contestphotoready/exportcsv"><?php echo $this->_tpl_vars['lang']['controller']['head_exportcsv']; ?>
</a></li>
		</ul>
		<div class="clear"></div>  
					...
					<thead>
						<tr>
						   <th align="center"><input class="check-all" type="checkbox" /></th>
							<th width="30" align="left"><a href="<?php echo $this->_tpl_vars['filterUrl']; ?>
...
sortby/username/sorttype/<?php if ($this->_tpl_vars['formData']['sortby'] == 'username'): ?><?php if (((is_array($_tmp=$this->_tpl_vars['formData']['sorttype'])) ? $this->_run_mod_handler('upper', true, $_tmp) : smarty_modifier_upper($_tmp)) != 'DESC'): ?>DESC<?php else: ?>ASC<?php endif; ?><?php endif; ?>">Poster</a></th>	
							<th class="td_center"><a href="<?php echo $this->_tpl_vars['filterUrl']; ?>
sortby/country/sorttype/<?php if ($this->_tpl_vars['formData']['sortby'] == 'username'): ?><?php if (((is_array($_tmp=$this->_tpl_vars['formData']['sorttype'])) ? $this->_run_mod_handler('upper', true, $_tmp) : smarty_modifier_upper($_tmp)) != 'DESC'): ?>DESC<?php else: ?>ASC<?php endif; ?><?php endif; ?>">Country</a></th>			
...
?>
						<?php $this->assign('id', $this->_tpl_vars['photo']->section); ?>
						<tr>
...
" width="60" /></a></td>
                            <?php endif; ?>
							<td><?php echo $this->_tpl_vars['groups'][$this->_tpl_vars['id']]; ?>
</td>
...
"><b><?php echo $this->_tpl_vars['photo']->name; ?>
							...
							<td align="left"><?php echo $this->_tpl_vars['photo']->poster->username; ?>
</td>
							<td class="td_center"><?php echo $this->_tpl_vars['photo']->userCountry; ?>
</td>
							<td align="left"><?php echo ((is_array($_tmp=$this->_tpl_vars['photo']->datecreated)) ? $this->_run_mod_handler('date_format', true, $_tmp) : smarty_modifier_date_format($_tmp)); ?>
</td>
							<td><a title="<?php echo $this->_tpl_vars['lang']['controllergroup']['formActionDeleteTooltip']; ?>
" href="javascript:delm('<?php echo $this->_tpl_vars['conf']['rooturl_admin']; ?>
photocontestready/delete/id/<?php echo $this->_tpl_vars['photo']->id; ?>
/redirect/<?php echo $this->_tpl_vars['redirectUrl']; ?>
...
" class="text-input" />
					<select name="fsearchin" id="fsearchin">
						<option value="">- - - - - - - - - - - - -</option>
						<option value="name" <?php if ($this->_tpl_vars['formData']['fsearchin'] == 'name'): ?>selected="selected"<?php endif; ?>>Photo Name</option>
						<option value="section" <?php if ($this->_tpl_vars['formData']['fsearchin'] == 'section'): ?>selected="selected"<?php endif; ?>>Section</option>
						<option value="country" <?php if ($this->_tpl_vars['formData']['fsearchin'] == 'country'): ?>selected="selected"<?php endif; ?>>Country</option>
