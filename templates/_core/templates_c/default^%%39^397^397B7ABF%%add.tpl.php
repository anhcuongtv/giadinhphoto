<?php /* Smarty version 2.6.26, created on 2014-08-28 18:09:05
         compiled from _controller/admin/judger/add.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'htmlspecialchars', '_controller/admin/judger/add.tpl', 25, false),)), $this); ?>
...
: </label>
					<select name="fiscolor" id="fiscolor">						
						<option value="0" <?php if ($this->_tpl_vars['formData']['fiscolor'] == '0'): ?>selected="selected"<?php endif; ?>><?php echo $this->_tpl_vars['lang']['controllergroup']['formNoLabel']; ?>
</option>
...
: </label>
					<select name="fismono" id="fismono">
						<option value="0" <?php if ($this->_tpl_vars['formData']['fismono'] == '0'): ?>selected="selected"<?php endif; ?>><?php echo $this->_tpl_vars['lang']['controllergroup']['formNoLabel']; ?>
</option>
                        <option value="1"><?php echo $this->_tpl_vars['lang']['controllergroup']['formYesLabel']; ?>
</option>
					</select>
...
: </label>
					<select name="fisnature" id="fisnatre">
					    <option value="0" <?php if ($this->_tpl_vars['formData']['fisnature'] == '0'): ?>selected="selected"<?php endif; ?>><?php echo $this->_tpl_vars['lang']['controllergroup']['formNoLabel']; ?>
</option>
                        <option value="1"><?php echo $this->_tpl_vars['lang']['controllergroup']['formYesLabel']; ?>
</option>
					</select>
...
: </label>
                    <select name="fistravel" id="fistravel">                        
                        <option value="0" <?php if ($this->_tpl_vars['formData']['fistravel'] == '0'): ?>selected="selected"<?php endif; ?>><?php echo $this->_tpl_vars['lang']['controllergroup']['formNoLabel']; ?>
</option>
                        <option value="1"><?php echo $this->_tpl_vars['lang']['controllergroup']['formYesLabel']; ?>
</option>
                    </select>
