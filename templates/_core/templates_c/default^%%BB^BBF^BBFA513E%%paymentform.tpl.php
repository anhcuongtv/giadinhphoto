<?php /* Smarty version 2.6.26, created on 2012-08-14 00:23:51
         compiled from _controller/site/checkout/paymentform.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'html_options', '_controller/site/checkout/paymentform.tpl', 81, false),)), $this); ?>
 ...
 ?>
		...
		<div id="tabpayment">
				...
				<div class="paymentOptionList">
					<?php if ($this->_tpl_vars['me']->paidColor == 0): ?> <?php if (in_array ( $this->_tpl_vars['packId'] , $this->_tpl_vars['setting']['payment']['packBinCodeColor'] )): ?><img src="<?php echo $this->_tpl_vars['staticserver']; ?>
<?php echo $this->_tpl_vars['currentTemplate']; ?>
/images/tick_circle.png" alt="YES" /><?php else: ?><img src="<?php echo $this->_tpl_vars['staticserver']; ?>
<?php echo $this->_tpl_vars['currentTemplate']; ?>
/images/cross_circle.png" alt="YES" /><?php endif; ?> <?php echo $this->_tpl_vars['lang']['global']['photoSectionColor']; ?>
 <br /><?php endif; ?>
					
					<?php if ($this->_tpl_vars['me']->paidMono == 0): ?><?php if (in_array ( $this->_tpl_vars['packId'] , $this->_tpl_vars['setting']['payment']['packBinCodeMono'] )): ?><img src="<?php echo $this->_tpl_vars['staticserver']; ?>
<?php echo $this->_tpl_vars['currentTemplate']; ?>
/images/tick_circle.png" alt="YES" /><?php else: ?><img src="<?php echo $this->_tpl_vars['staticserver']; ?>
<?php echo $this->_tpl_vars['currentTemplate']; ?>
/images/cross_circle.png" alt="YES" /><?php endif; ?> <?php echo $this->_tpl_vars['lang']['global']['photoSectionMono']; ?>
 <br /><?php endif; ?>
					...
					<?php if ($this->_tpl_vars['me']->paidNature == 0): ?><?php if (in_array ( $this->_tpl_vars['packId'] , $this->_tpl_vars['setting']['payment']['packBinCodeNature'] )): ?><img src="<?php echo $this->_tpl_vars['staticserver']; ?>
<?php echo $this->_tpl_vars['currentTemplate']; ?>
/images/tick_circle.png" alt="YES" /><?php else: ?><img src="<?php echo $this->_tpl_vars['staticserver']; ?>
<?php echo $this->_tpl_vars['currentTemplate']; ?>
/images/cross_circle.png" alt="YES" /><?php endif; ?> <?php echo $this->_tpl_vars['lang']['global']['photoSectionNature']; ?>
 <br /><?php endif; ?>
                    <?php if ($this->_tpl_vars['me']->paidTravel == 0): ?><?php if (in_array ( $this->_tpl_vars['packId'] , $this->_tpl_vars['setting']['payment']['packBinCodeTravel'] )): ?><img src="<?php echo $this->_tpl_vars['staticserver']; ?>
<?php echo $this->_tpl_vars['currentTemplate']; ?>
/images/tick_circle.png" alt="YES" /><?php else: ?><img src="<?php echo $this->_tpl_vars['staticserver']; ?>
<?php echo $this->_tpl_vars['currentTemplate']; ?>
/images/cross_circle.png" alt="YES" /><?php endif; ?> <?php echo $this->_tpl_vars['lang']['global']['photoSectionTravel']; ?>
 <br /><?php endif; ?>
				</div>
