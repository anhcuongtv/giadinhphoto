<?php /* Smarty version 2.6.26, created on 2016-09-18 17:18:42
         compiled from _controller/site/checkout/placeorder.tpl */ ?>
<div id="panelright" style="width:1000px">
	<div id="page">
		<h1><?php echo $this->_tpl_vars['lang']['controller']['paymentTitle']; ?>
</h1>
		<div>

		<div align="left" style="font-weight:bold;font-size:28px;margin-bottom:10px;margin-left:10px;"><?php echo $this->_tpl_vars['lang']['controller']['finishOrderCompleted']; ?>
<hr align="left" color="#CCCCCC" width="100%" size="1"></div>
		
		<div align="left" style="margin-left:10px;color:#0066FF;font-weight:bold;font-size:14px;">
			<?php echo $this->_tpl_vars['lang']['controller']['finishPlaceOrderContactText']; ?>
