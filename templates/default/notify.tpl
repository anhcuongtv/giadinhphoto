...
<div class="notify-bar notify-bar-success">
	<div class="notify-bar-icon"><img src="{$staticserver}{$currentTemplate}/images/notify/success.png" align="success" /></div>
	<div class="notify-bar-button"><a href="javascript:void(0);" onclick="javascript:$(this).parent().parent().fadeOut();" title="close"><img src="{$staticserver}{$currentTemplate}/images/notify/close-btn.png" border="0" alt="close" /></a></div>
...
<div class="notify-bar notify-bar-error">
	<div class="notify-bar-icon"><img src="{$staticserver}{$currentTemplate}/images/notify/error.png" align="error" /></div>
	<div class="notify-bar-button"><a href="javascript:void(0);" onclick="javascript:$(this).parent().parent().fadeOut();" title="close"><img src="{$staticserver}{$currentTemplate}/images/notify/close-btn.png" border="0" alt="close" /></a></div>
	<div class="notify-bar-text">
...
<div class="notify-bar notify-bar-warning">
	<div class="notify-bar-icon"><img src="{$staticserver}{$currentTemplate}/images/notify/warning.png" alt="warning" /></div>
	<div class="notify-bar-button"><a href="javascript:void(0);" onclick="javascript:$(this).parent().parent().fadeOut();" title="close"><img src="{$staticserver}{$currentTemplate}/images/notify/close-btn.png" border="0" alt="close" /></a></div>
	<div class="notify-bar-text">
...
<div class="notify-bar notify-bar-info">
	<div class="notify-bar-icon"><img src="{$staticserver}{$currentTemplate}/images/notify/info.png" alt="info" /></div>
	<div class="notify-bar-button"><a href="javascript:void(0);" onclick="javascript:$(this).parent().parent().fadeOut();" title="close"><img src="{$staticserver}{$currentTemplate}/images/notify/close-btn.png" border="0" alt="close" /></a></div>
	<div class="notify-bar-text">
