...
<div class="content-box"><!-- Start Content Box -->
	<div class="content-box-header">		
		...
		<ul class="content-box-link">
			<li><a href="{$conf.rooturl_admin}product/add">{$lang.controller.head_add}</a></li>
		</ul>
		<div class="clear"></div>  
				...
				{if $products|@count > 0}
					...
					{foreach item=myProduct from=$products}
						...
						<tr>
							...
							<td align="left"><a href="{$conf.rooturl_admin}product/edit/id/{$myProduct->id}/redirect/{$redirectUrl}">{$myProduct->name_vn}</a>
							</td>
							<td class="td_right">{$currency->formatPrice($myProduct->price_vn)}</td>
