	...
	<div class="content-box-content">
		<div class="tab-content default-tab" id="tab1">
			{include file="notify.tpl" notifyError=$error notifySuccess=$success notifyWarning=$warning}
				...
				{if $formData.fimage!=''}
				<p>
				<img style="border:1px solid #999999;" alt="{$formData.fname.$langCode}" src="{$conf.rooturl}{$setting.news.imageDirectory}{$formData.fsmallImage}" width="100" height="100"/>
				<label><input type="checkbox" name="fdeleteimage" value="1" /> {$lang.controller.formImageDeleteLabel}</label>
