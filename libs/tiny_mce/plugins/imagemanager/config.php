...
//customize using custom session handler by tuanmaster2002@yahoo.com
	...
	$mcImageManagerConfig['filesystem.path'] = '../../../../uploads/images'; // absolute or relative from this script path, optional.
	$mcImageManagerConfig['filesystem.rootpath'] = '../../../../uploads/images'; // absolute or relative from this script path, required.
