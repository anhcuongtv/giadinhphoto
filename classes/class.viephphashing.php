...
Class viephpHashing
{
	public static $secretString = 'kgcttteanennad5937akadfaw';	//never change this string, if not, all account will invalid.	
	public static $salt = '292jsjsalalkjasdf93dk3k29akadsif3k';	//if change this value, user password cookie will invalid.
	...
	public static function authenticate($source, $dest)
	{
		...
		$group = split(self::$saltSeperator, $dest);
		$hash = $group[0];
	...
	{
		$group = split(self::$saltSeperator, $cookieHashing);
	...
	{
		$group = split(self::$saltSeperator, $fullPasswordString);
